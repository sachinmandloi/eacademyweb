				...
				<div class="row">
				    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="edu_title_wrapper">
							<h4 class="edu_filter_title white"><?php echo html_escape($this->common->languageTranslator('ltr_today_homework'));?></h4>
						</div>
                    </div>
					<?php 
					if(!empty($todayHW)){ 
						foreach($todayHW as $hw){
							echo '<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
								<div class="edu_extra_class">
									<p class="clsdesc"><span class="boldText"><i class="icofont-law-document"></i> '.html_escape($this->common->languageTranslator('ltr_description')).' - </span>'.$hw['description'].'</p>
									<p class="clstime"><i class="icofont-file-document"></i><span class="boldText">'.html_escape($this->common->languageTranslator('ltr_subject')).' - </span>'.$hw['subject_name'].'</p>
									<p class="clsby"><i class="icofont-ui-user"></i><span class="boldText"> By - </span>'.$hw['name'].(($hw['teach_gender'] == 'male')?' Sir':' Mam').' </p>
								</div>
							</div>';
						}
					}else{
						...
						<div class="edu_extra_class">
							<p class="clsdesc">'.html_escape($this->common->languageTranslator('ltr_no_homework')).'</p>
						</div>
						</div>';
					} ?>	
				</div>
