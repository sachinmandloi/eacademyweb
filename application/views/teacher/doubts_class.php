                ...
                <div class="row">
    				<div class="col-lg-6 col-md-12 col-sm-12 col-12">
    					<div class="form-group">
							...
							<input type="hidden" class="form-control require hasDatepicker" placeholder="Start Date" id="b_startDate" value="">
                ...
                <div class="row">   
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control require alphaField" name="batch" placeholder="Batch Name">
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                        <div class="form-group">
