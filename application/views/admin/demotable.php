...
.edu_certifiate_wrapper {
    background: url(http://themes91.in/ci/e-academy/assets/images/certificate_bg.png);
    width: 1203px;
    height: 871px;
    margin: auto;
    position: relative;
        ...
        <div class="edu_certifiate_wrapper">
            ...
            <div class="certifiate_sign">
             ...
             <div class="certifiate_main_logo">
                <img src="http://themes91.in/ci/e-academy/assets/images/cirtificate_mainlogo.png" class="certificate_logo" alt="Logo">
            </div>
        </div>
    </div>
</body>
