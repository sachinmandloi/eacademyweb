					...
					<div class="col-lg-8 col-md-8 col-sm-8 col-12 padder0">
						...
						<div class="edu_courses_section notic_mng">
							<ul class="nav nav-tabs" role="tablist">
							    <li class="nav-item tabTableCls" data-url="ajaxcall/notice_table/common">
								...
								<li class="nav-item tabTableCls" data-url="ajaxcall/notice_table/student">
								...
								<li class="nav-item tabTableCls" data-url="ajaxcall/notice_table/teacher">
