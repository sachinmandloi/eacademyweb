						...
						<div class="col-lg-6 col-md-6 col-sm-12 col-12">
							...
							<div class="edu_btn_wrapper">
								<div class="col-lg-12 col-md-12 col-sm-12 col-12"> 
									...
									<a href="<?php echo base_url();?>admin/view-certificate" class="edu_admin_btn " target="_blank"><?php echo html_escape($this->common->languageTranslator('ltr_view_certificate'));?> </a>
								</div>
							</div>
						</div>
					</div>
