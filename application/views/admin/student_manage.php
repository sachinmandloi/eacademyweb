                    ...
                    <div class="edu_manage_studer_filter"> 
                        <div class="row">
                            ...
                            <div class="col-lg-2 col-md-4 col-sm-4 col-xs-12">
                                ...
                                <div class="form-group"> 
                                    <span> 
                                        <select class="form-control edu_selectbox_without_search" id="user_batch" name="user_batch">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 text-sm-right">
                                <div class="form-group"> 
    		...
    		<div class="edu_admin_informationdiv sectionHolder">
    		    <div class="ppr_popup_inner student_mng_m">
        			<div class="footer_popup_inner">
						 ...
						 <div class="fp_btn_wrpa">
						     <button class="certificate btn btn-primary" data-table="students" data-column="id"><?php echo html_escape($this->common->languageTranslator('ltr_add_certificate'));?></button>
						 </div>
                        <?php }else{ ?>
                        <div class="fp_btn_wrpa">
        			        <button class="btn btn-primary add_attendance "><?php echo html_escape($this->common->languageTranslator('ltr_add_regular_attendance'));?></button>
