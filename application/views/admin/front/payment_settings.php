						...
						<div class="row">
							...
							<div class="col-lg-6 col-md-6 col-sm-12 col-12">
							    <div class="form-group">
									...
									<input type="text" class="form-control " name="razorpay_key_id" value="<?php if(!empty($razorpay_key_id)){echo $razorpay_key_id;} ?>" placeholder="<?php echo html_escape($this->common->languageTranslator('ltr_key_id'));?>">
								</div>
							</div>
							<div class="col-lg-6 col-md-6 col-sm-12 col-12">
							    <div class="form-group">
							...
							<div class="col-lg-6 col-md-6 col-sm-12 col-12">
							    <div class="form-group">
									...
									<input type="text" class="form-control " name="paypal_client_id" value="<?php if(!empty($paypal_client_id)){echo $paypal_client_id ;} ?>" placeholder="<?php echo html_escape($this->common->languageTranslator('ltr_client_id'));?>">
								</div>
							</div>
							<div class="col-lg-6 col-md-6 col-sm-12 col-12">
							    <div class="form-group">
									<label><?php echo html_escape($this->common->languageTranslator('ltr_paypal_secret_key'));?><sup>*</sup></label>
									<input type="text" class="form-control" name="paypal_secret_key" value="<?php if(!empty($paypal_secret_key)){echo $paypal_secret_key; } ?>" placeholder="<?php echo html_escape($this->common->languageTranslator('ltr_secret_key'));?>">
								</div>
							</div>
							<div class="col-lg-6 col-md-6 col-sm-12 col-12">
							    <div class="form-group">
