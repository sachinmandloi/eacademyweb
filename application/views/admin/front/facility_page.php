			...
			<form class="pxn_amin" method="post">
				<div class="edu_facality_wrapper edu_from_wrapper">
					<div class="row">
						...
						<div class="col-lg-6 col-md-6 col-sm-12 col-12">
						    <div class="form-group">
								<label><?php echo html_escape($this->common->languageTranslator('ltr_no_of_facilities'));?><sup>*</sup></label>
							    <input type="number" class="form-control require" name="no_of_facility" value="<?php echo !empty($facility_Details)?$facility_Details['0']['no_of_facility']:'';?>" placeholder="<?php echo html_escape($this->common->languageTranslator('ltr_nu_of_facilities'));?>">
							</div>
						</div>
