                                                ...
                                                <div class="edu_home_wrapper edu_from_wrapper">
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                                        <div class="edu_admin_testimonials">
                                                            <div class="row">
                                                            <label><?php echo html_escape($this->common->languageTranslator('ltr_select_student'));?> &amp; <?php echo html_escape($this->common->languageTranslator('ltr_add_positions'));?><sup>*</sup></label>
                                                                <?php 
                                                                ...
                                                                <?php } }else{ ?>
                                                                    <div class="parentRow">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-lg-6 col-md-6 col-sm-12 col-12"> 
                                                                                <div class="form-group edu_delet_icon_input">
                                                                                    <input type="text" class="form-control require" name="select_desc[]" value="" placeholder="<?php echo html_escape($this->common->languageTranslator('ltr_description'));?>">
                                                                                    <div class="edu_detele_row_wrapper">
                                                                                        <i class="icofont-ui-delete removeRow" title="Remove"></i>
                                                                                </div>
                                                                                </div>
                                            ...
                                            <form method="post">
                                                <div class="edu_home_wrapper edu_from_wrapper">
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                                        <div class="edu_admin_testimonials">
                                                            <div class="row">
                                                                <label><?php echo html_escape($this->common->languageTranslator('ltr_select_student'));?> &amp; <?php echo html_escape($this->common->languageTranslator('ltr_add_their_feedbacks'));?><sup>*</sup></label>
                                                                <?php 
