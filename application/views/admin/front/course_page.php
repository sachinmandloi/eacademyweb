    			...
    			<div class="edu_main_wrapper edu_courses_wrapper edu_from_wrapper mb_30">
        			<div class="edu_section_wrap">
        				<div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-12">
        					    <div class="form-group">
        							<label><?php echo html_escape($this->common->languageTranslator('ltr_no_of_courses'));?><sup>*</sup></label>
        						    <input type="number" class="form-control require" name="no_of_course" value="<?php echo !empty($course_Details)?$course_Details['0']['no_of_course']:'';?>" placeholder="<?php echo html_escape($this->common->languageTranslator('ltr_nu_of_courses'));?>">
        						</div>
        					</div>
