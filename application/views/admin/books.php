<section class="edu_admin_content">
	<div class="edu_admin_right sectionHolder edu_subject_manager">			
		<div class="edu_btn_wrapper sectionHolder padderBottom30 text-right">
           <a href="#subjectsPopup" class="edu_admin_btn addBookPop"><i class="icofont-plus"></i><?php echo html_escape($this->common->languageTranslator('ltr_add_book')); ?></a>
	    </div>
...
<div id="bookPopup" class="edu_popup_container mfp-hide">
    <div class="edu_popup_wrapper">
        <div class="edu_popup_inner">
            <h4 class="edu_sub_title" id="classModalLabel"><?php echo html_escape($this->common->languageTranslator('ltr_add_subject')); ?></h4>
                ...
                <div class="row">
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-12">
    					<div class="edu_btn_wrapper">
							<input type="button" name="addBook" value="<?php echo html_escape($this->common->languageTranslator('ltr_add')); ?>" class="edu_admin_btn addBook" data-id="" />
						</div>
    				</div>
				</div>
            </form>
