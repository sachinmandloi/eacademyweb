				...
				<div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="edu_accordion_container_heading">
                            ...
                            if(!empty($batch_fecherd)){
                                ...
                                <div class="edu_accord_parent">
                                    <span class="edu_accordion_header">
										<span class="speci_heading"><?php echo isset($value['batch_specification_heading'])?$value['batch_specification_heading']: html_escape($this->common->languageTranslator('ltr_heading'));?></span> 
										<i>
                            ...
                            <div class="edu_accord_parent">
                                <span class="edu_accordion_header">
                                    <span class="speci_heading"><?php echo html_escape($this->common->languageTranslator('ltr_heading'));?></span> 
                                    <i>
                                        <i class="fa fa-angle-right upDownI"></i>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="edu_btn_wrapper">
                            ...
                            <button type="button" class="edu_admin_btn AssignBatchHeading">+ <?php echo html_escape($this->common->languageTranslator('ltr_assign_heading'));?></button>
