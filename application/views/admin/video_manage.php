<section class="edu_admin_content">
	<div class="edu_admin_right sectionHolder edu_video_manager">
	    ...
	    <div class="edu_btn_wrapper sectionHolder padderBottom30 text-right">
            <?php echo ($role != 'student')?'<a href="#add_video_popup" class="edu_admin_btn openPopupLink"><i class="icofont-plus"></i>'.html_escape($this->common->languageTranslator('ltr_add_video')).'</a>':''; ?>
	    </div>
				...
				<div class="row">
					<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
						<div class="form-group">
							<span>
                                <select class="form-control filter_subject edu_selectbox_with_search" name="filter_subject" data-placeholder="<?php echo html_escape($this->common->languageTranslator('ltr_select_sebject'));?>" data-count="no">
                                    <option value=""><?php echo html_escape($this->common->languageTranslator('ltr_select_sebjects'));?></option>
                                    <?php
                                    if(!empty($subject)){
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
						<div class="form-group">
							<span>
                                <select  class="form-control filter_chapter edu_selectbox_with_search" name="filter_chapter" data-placeholder="<?php echo html_escape($this->common->languageTranslator('ltr_select_chpter'));?>"> 
                                    <option value=""><?php echo html_escape($this->common->languageTranslator('ltr_select_chpter'));?></option>
                                </select>
							</span>
						</div>
					</div>
        ...
        <div class="createDivWrapper edu_add_question create_ppr_popup hide">
    		<div class="edu_admin_informationdiv sectionHolder">
    		    <div class="ppr_popup_inner">
					...
					<?php if($role != 'student'){?>
                    <button class="multiDelete btn_delete btn btn-primary" data-toggle="tooltip" data-placement="top" title="Delete" data-table="video_lectures" data-column="id"><?php echo html_escape($this->common->languageTranslator('ltr_delete'));?></button>
                    <?php }?>
        		</div>
					</div>
        		</div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 col-12">
    					<div class="form-group">
                            ...
                            <select class="form-control require edu_selectbox_with_search video_batch" name="batch[]" multiple data-placeholder="<?php echo html_escape($this->common->languageTranslator('ltr_select_batch'));?>">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="form-check form-check-inline">
                          <input class="form-check-input require" type="radio" name="video_type" id="inlineRadio1" value="youtube">
                        ...
                        <div class="form-check form-check-inline">
                          ...
                          <label class="form-check-label" for="inlineRadio3">Dropbox</label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input class="form-check-input require" type="radio" name="video_type" id="inlineRadio4" value="embed">
                          <label class="form-check-label" for="inlineRadio4">embed</label>
                        </div>
    				...
    				<div class="col-lg-12 col-md-12 col-sm-12 col-12">
    					<div class="form-group">
                            ...
                            <input type="text" class="form-control require video_url"  name="url" data-valid="youtube" data-error="Please enter a valid URL." placeholder="URL" data-symb="no">
                        </div>
                    </div>
					<div class="col-lg-12 col-md-12 col-sm-12 col-12">
