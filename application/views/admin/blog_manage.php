	    ...
	    <div class="edu_btn_wrapper sectionHolder text-right">
    		...
    		<div class="edu_admin_informationdiv sectionHolder">
    		    <div class="ppr_popup_inner">
					...
					<button class="multiDelete btn_delete btn btn-primary" data-toggle="tooltip" data-placement="top" title="Delete" data-table="blog" data-column="id"><?php echo html_escape($this->common->languageTranslator('ltr_delete'));?></button>
        		</div>
					</div>
        		</div>
    		</div>
