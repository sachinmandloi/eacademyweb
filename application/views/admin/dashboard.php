    			...
    			<?php if($role == '1'){  ?>
    				<div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
    					...
    					<div class="edu_color_boxes box_left">
    						...
    						<div class="edu_dash_info">
        					    <ul>
    					            <li><p><?php echo html_escape($this->common->languageTranslator('ltr_present'));?> <span><?php echo html_escape($dashboard_count['total_present']);?></span></p></li>
    					            <li><p><?php echo html_escape($this->common->languageTranslator('ltr_absent'));?> <span><?php echo html_escape($dashboard_count['total_student']-$dashboard_count['total_present']);?></span></p></li>
    					        <ul>
    					    </div>
    					</div>
    					</a>
    				...
    				<div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
    					...
    					<div class="edu_color_boxes box_center">
    						...
    						<div class="edu_dash_info">
    					        <ul>
    					            <li><p><?php echo html_escape($this->common->languageTranslator('ltr_active'));?> <span><?php echo html_escape($dashboard_count['active_batch']);?></span></p></li>
    					            <li><p><?php echo html_escape($this->common->languageTranslator('ltr_inactive'));?> <span><?php echo html_escape($dashboard_count['inactive_batch']);?></span></p></li>
    					        <ul>
    					    </div>
    					</div>
    					</a>
    				...
    				<div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
    					<a href="<?php echo base_url()?>admin/question-manage">
        					<div class="edu_color_boxes box_right">
        						...
        						<div class="edu_dash_info">
        					        <ul>
        					            <li><p><?php echo html_escape($this->common->languageTranslator('ltr_vimp'));?> <span><?php echo html_escape($dashboard_count['vimp_question']);?></span></p></li>
        					            <li><p><?php echo html_escape($this->common->languageTranslator('ltr_imp'));?> <span><?php echo html_escape($dashboard_count['imp_question']);?></span></p></li>
        					        <ul>
        					    </div>
        					</div>
    					</a>
    				...
    				<div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
    					<div class="edu_color_boxes box_other">
    						...
    						<div class="edu_dash_info">
    					        <ul>
    					            <li><p> <a href="<?php echo base_url()?>admin/manage-student-leave"><?php echo html_escape($this->common->languageTranslator('ltr_student'));?> <span><?php echo html_escape($dashboard_count['student_leave']);?></span></a></p></li>
    					            <li><p> <a href="<?php echo base_url()?>admin/manage-teacher-leave"><?php echo html_escape($this->common->languageTranslator('ltr_teacher'));?> <span><?php echo html_escape($dashboard_count['teacher_leave']);?></span></a></p></li>
    					        <ul>
    					    </div>
    					</div>
    				</div>
					    ...
					    <div class="custom_container"> 
    						<div class="row"> 
    						    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
    						        <a class="edu_quick_links light_red_bg" target="_blank" href="<?php echo base_url();?>admin/course-manage">
								       <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
    						    ...
    						    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
    						        <a class="edu_quick_links light_voilate_bg" target="_blank" href="<?php echo base_url();?>admin/enquiry">
								       <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                    	 viewBox="0 0 448.011 448.011" style="enable-background:new 0 0 448.011 448.011;" xml:space="preserve">
                                        	<g>
                                        		<g>
    								    ...
    								    <?php echo html_escape($this->common->languageTranslator('ltr_enquiry_manager'));?>
    								</a>
    						    </div>
    						</div>
						</div>
