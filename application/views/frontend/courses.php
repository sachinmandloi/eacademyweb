				...
				<div class="row">
					...
					<div class="col-lg-5 col-md-5 col-sm-12 col-12">
						<div class="edu_courseInfo_box relative mb_30">
							...
							<p><?php echo html_escape($this->common->languageTranslator('ltr_provide_you'));?> <?php echo html_escape($totalCourse);?>+ <?php echo html_escape($this->common->languageTranslator('ltr_courses'));?></p>
						</div>
					</div>
				</div>
			</div>
