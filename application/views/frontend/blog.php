            ...
            <div class="col-lg-8 col-md-12 col-sm-12 col-12">
				...
				<?php if(!empty($blog)){ 
                    ...
                    <div class="edu_sglblog_inner bgshadowradios mb_30">
                        ...
                        <p class="edu_sglblog_des mb_30"><?php if(!empty($value['description'])){ if(strlen($value['description'])<250){ echo  substr(strip_tags($value['description']), 0, 250) ;}else{ echo  substr(strip_tags($value['description']), 0, 250); ?> <a href="<?php echo base_url('/blog/').$value['id']; ?>"><?php echo html_escape($this->common->languageTranslator('ltr_read_more'));?> </a> <?php } } ?></p>
                    </div>
					<?php }
						}else{
