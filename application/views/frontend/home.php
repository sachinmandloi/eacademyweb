<!----- Banner Wraapper ----->
		...
		<section class="edu_services_wrapper">
			<div class="container">
				<div class="row">
					...
					<?php
						if(!empty($frontend_details[0]['no_of_facility']) && $frontend_details[0]['no_of_facility'] > 0){
		...
		<section class="edu_courses_wrapper">
			...
			<?php if(!empty($frontend_details[0]['no_of_course']) && $frontend_details[0]['no_of_course'] > 0){ ?>
			<div class="container-fluid">
				<div class="row">
						...
						<div class="edu_courses_section">
							...
							<?php
								...
								if(!empty($Allcourses)){
									...
									$tabContent .= '<div role="tabpanel" class="tab-pane fade '.$activeCont.'" id="courseType'.$i.'">
									<div class="edu_courses_content">
										<div class="edu_courses_content_inner">
											<div class="row">
												<div class="col-lg-6 col-md-12 col-sm-12 col-12">
													<div class="edu_courses_img relative">
														<div class="edu_courses_img_holder">
															<img src="'.base_url().'uploads/courses/'.$crs['image'].'" alt=""/>
														</div>
													</div>
												</div>
												<div class="col-lg-6 col-md-12 col-sm-12 col-12">
													<div class="edu_courses_detail">
														<h4>'.$crs['course_name'].'</h4>
														<p>'.$crs['description'].'</p>
														<ul>
															<li>
																...
																<div class="edu_course_info_text">
																	<p>'.$crs['course_duration'].' Course</p>
																</div>
															</li>
															<li>
																<span class="edu_course_info_icon">
															...
															<li>
																...
																<div class="edu_course_info_text">
																	<p>'.$crs['time_duration'].' Class Duration</p>
																</div>
															</li>
														</ul>
													</div>
