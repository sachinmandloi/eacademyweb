		...
		var Education = {
    		...
    		dropDown: function () {
                ...
                $('.edu_admin_bar').on("click", function(e) {
                	e.stopPropagation();
            		if (count == '0') {
            			$('.edu_admin_option').addClass('show');
            			count++;
            		} else {
                ...
                $('.edu_admin_option a').on('click',function(event) {
                    event.stopPropagation();
                });
                $('body').on("click", function() {
            		if (count == '1') {
    		...
    		actionDropdown: function () {
				$(document).on('click','.tbl_action_drop', function(e){
				    $('.actions_wrap_dot').removeClass('tbl_action_drop_open');
                    $(this).parent().toggleClass('tbl_action_drop_open');
                     e.stopPropagation();
                });
                $('body').on('click', function(){ 
                    $('.actions_wrap_dot').removeClass('tbl_action_drop_open');
